...
public class TablaHashLinearProbing<K extends Comparable<K>, V extends Comparable<V>> implements ITablaSimbolos<K, V> {
    ...
    @Override
    public void poner(K key, V value) {
    ...
    public void rehash() {
        try {
            ...
            for (int i = 1; i <= nodos.size(); i++) {
                ...
                poner(actual.getKey(), actual.getValue());
            }
    ...
    public String toString() {
        ...
        retorno.append("La cantidad de duplas: ").append(keySet().size());
        retorno.append("\nEl m inicial es: ").append(minicial);
        retorno.append("\nEl m final es: ").append(tamanoTabla);
        double tam = tamanoAct;
        double tam2 = tamanoTabla;
        DecimalFormat df = new DecimalFormat("###.##");
        double tamañoCarga = tam / tam2;
        retorno.append("\nEl factor de carga es: ").append(df.format(tamañoCarga));
        retorno.append("\nLa cantidad de rehash es: ").append(cantidadRehash);
