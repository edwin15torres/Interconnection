...
public class YoutubeVideo implements Comparable<YoutubeVideo> {
    ...
    public YoutubeVideo(String pId, Date ptrending, String pTitulo, String pTituloCanal, int pIdCategoria, Date pTiempoPub,
                        String pTags, int pViews, int pLikes, int pDislikes, int pComentarios, String pLink,
                        boolean pComentariosDesac, boolean pRatingsDesac, boolean pError, String pDescripcion, String pPais, String pLLave) {
        id = pId;
    ...
    public static class ComparadorXLikes implements Comparator<YoutubeVideo> {
         ...
         *
         * @return valor 0 si video1 y video2 tienen los mismos likes. valor negativo si
        ...
        public int compare(YoutubeVideo video1, YoutubeVideo video2) {
            return Integer.compare(video1.darLikes(), video2.darLikes());
        }
    }
